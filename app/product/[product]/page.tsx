          ...
          <div className="w-[60%] flex flex-col gap-6 p-5 ">
            <div className="w-full justify-between flex">
              ...
              <div className="p-2 text-white text-center bg-lime-500">
                <p className="text-sm  mr-2">{product.Rating || 5} &#9733;</p>
            ...
            <div className=" flex flex-col gap-2">
              ...
              <p className="text-slate-600 mt-2">
                ...
                rooms. The rooms are spacious and well-toned. The furniture is
                elegant and the flooring is wooden. The reception is charming
                and has modern sofas.
              </p>
            </div>
            <div className=" flex flex-col gap-2">
              <h2 className="text-2xl font-semibold text-slate-900">
